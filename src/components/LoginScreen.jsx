      ...
      <div className="relative z-10 w-full md:w-[45%] lg:w-[40%] flex flex-col items-center justify-center pt-24 pb-6 px-8 lg:px-16 bg-[#030108]">
        ...
        <div className="bg-zinc-950/70 backdrop-blur-2xl border border-zinc-800/80 rounded-3xl p-6 shadow-[0_0_80px_rgba(0,0,0,0.6),0_0_40px_rgba(139,92,246,0.05)]">
          ...
          <div className="flex items-center gap-3 mt-6 mb-6">
            ...
            <div className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">OR</div>
            <div className="flex-1 h-px bg-zinc-800/80"></div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-200 text-zinc-950 font-bold py-3.5 rounded-xl transition-all text-sm shadow-[0_4px_14px_rgba(255,255,255,0.1)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          {/* Security badge */}
          <div className="flex items-center justify-center gap-1.5 text-[9px] text-zinc-600 font-medium mt-6">

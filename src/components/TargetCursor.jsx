...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      // Also hide cursor for elements that usually force a cursor
    ...
    const moveHandler = e => {
      ...
      // If the target element was removed from the DOM (e.g. state change on click), reset cursor
    ...
    const enterHandler = e => {
      ...
      // Adjust to make the target box fit closely around the element
      const padding = 8;
      targetCornerPositionsRef.current = [
        { x: rect.left - padding, y: rect.top - padding },
        { x: rect.right + padding - cornerSize, y: rect.top - padding },
        { x: rect.right + padding - cornerSize, y: rect.bottom + padding - cornerSize },
        { x: rect.left - padding, y: rect.bottom + padding - cornerSize }
      ];
